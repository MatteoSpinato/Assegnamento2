...
class Order
{
    ...
    private:
	    ...
	    void fillComponentToBuy(components &orderComponents, std::vector <priceAssociation> &toFill);
	    int time_stamp;
	    int model_id;
	    int quantity_ordered;

	    bool ready; //serve per aspettare in modo semplice il mese che impiega ad essere costruito
	    double price;
